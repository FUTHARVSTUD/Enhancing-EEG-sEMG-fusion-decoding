...
class TemporalConvUnit(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = nn.Conv2d(in_channels, out_channels, kernel_size=(1, 3), stride=(2, 15))
...
class AMPCNet(nn.Module):
    def __init__(self, num_classes): 
        ...
        time_conv_channels = 32 
        freq_conv_channels = 32
        tf_conv_channels = 32  

        self.time_conv = TimeConvBlock(16, time_conv_channels)
        self.freq_conv = FreqConvBlock(16, freq_conv_channels)
        self.tf_conv = TFConvBlock(16, tf_conv_channels)
